...
=========================
Runs inference on test images using the best MambaVision_S full image model.
Samples 50 images across 7 source datasets (same structure as 07_inference_pipeline.py).
Produces annotated images in the same format for direct visual comparison in the paper.
...
Run:
    python 07b_inference_pipeline.py

Output:
    results/inference_images_fullimage/   — annotated images
    results/inference_summary_fullimage.json
"""
...
print("Loading MambaVision_S full image best model...")
...
# ═════════════════════════════════════════════════════════════════════════════
# 6. FONTS — exact same as 07_inference_pipeline.py
# ═════════════════════════════════════════════════════════════════════════════
...
# ═════════════════════════════════════════════════════════════════════════════
# 8. ANNOTATE FUNCTION — exact same panel spec as 07_inference_pipeline.py
# ═════════════════════════════════════════════════════════════════════════════
...
summary_path = os.path.join(RESULTS_DIR, "inference_summary_fullimage.json")
